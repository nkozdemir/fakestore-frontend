...
export function useUsernameAvailability() {
  ...
  const checkAvailability = useCallback(async (rawUsername: string): Promise<CheckResult> => {
    ...
    try {
      const result = await fetchJson<UsernameAvailabilityResponse>("/auth/validate-username/", {
